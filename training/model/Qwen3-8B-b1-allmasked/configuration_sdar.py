...
class SDARConfig(PretrainedConfig):
    ...
    Args:
        ...
        use_regular_causal (`bool`, *optional*, defaults to `True`):
            Whether to use regular autoregressive causal mask instead of block-causal mask for the x0 region during training.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_regular_causal = use_regular_causal
